...
(5, NULL, NULL, 2, 3, 'Nowab Shorif', NULL, 3, '2345678', 'noman@gmail.com', '$2y$10$Gr2OiWKHtQ6MXpA3OEWMgOYDQPEMyTvngY94wY15lFqwJoG5YsXFO', NULL, 1, '2025-07-23 04:43:12', '2025-09-18 08:32:49', NULL),
...
(7, NULL, NULL, 4, 3, 'Noakhali Branch', NULL, 3, '010839317038', 'noakhalibranch@gmail.com', '$2y$10$e6lDM0myw3.ozdg2NcZkW.mA4jqDZ5XKW3HlWTn/TyQ6CpGLrZx4y', NULL, 1, '2025-09-18 12:15:40', '2025-09-18 12:16:04', 'fzsnov4G257YnzFUTb5BI6SKlZJxXol2auSsBHmB2FGTTJThLluzYJKLZUCK');
...
(4, 3, 'Noakhali Branch', 'noakhalibranch@gmail.com', '010839317038', '', 0.00, 0, 1, '2025-09-18 12:15:40', '2025-09-18 12:15:40');
...
(225, 212, 3, 'Parcel Outgoing', '<i class=\"far fa-dot-circle nav-icon\"></i>', 1, 'parcel-transfer-outgoing.create', 'parcel-transfer-outgoing.index', 1, '2025-08-18 09:19:21', '2025-09-18 09:21:45'),
(226, 212, 14, 'Parcel Incoming', '<i class=\"far fa-dot-circle nav-icon\"></i>', 1, NULL, 'parcel-transfer-incoming.index', 1, '2025-09-18 12:05:53', '2025-09-18 12:08:08');
...
(147, '2025_08_18_150131_create_parcel_transfers_table', 76),
(148, '2025_08_18_150804_create_parcel_transfer_details_table', 76);
...
CREATE TABLE `parcel_invoices` (
  ...
  `reference_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `hawb_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'house air waybill no',
  ...
  `payment_mode` enum('Prepaid','Collect') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cod_amount` decimal(10,2) NOT NULL COMMENT 'Cash On Delivery',
  `item_type` enum('SPX','DOCS') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `all_item_names` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `sender_company` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `sender_zip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `sender_origin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `receiver_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `receiver_company` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `receiver_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `receiver_city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `receiver_zip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `receiver_country_id` int NOT NULL,
  `receiver_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `receiver_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `receiver_origin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payment_type` enum('Cash','Due') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `usa_country_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `picked_up_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `picked_up_date_time` timestamp NOT NULL,
  `mawb_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Master Air Waybill',
  ...
  `parcel_status` enum('pending','approved','in_transit','delivered','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `parcel_transfers` (
  `id` bigint UNSIGNED NOT NULL,
  `parcel_transfer_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `from_branch_id` bigint UNSIGNED NOT NULL,
  `to_branch_id` bigint UNSIGNED NOT NULL,
  `transfer_date` date NOT NULL,
  `status` enum('pending','approved','in_transit','delivered','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
--
-- Dumping data for table `parcel_transfers`
--
...
(1, 'PT-000001', 3, 1, '2025-09-27', 'delivered', 1, NULL, 7, 1, '2025-09-27 03:52:47', '2025-09-27 03:53:49');

-- --------------------------------------------------------

--
-- Table structure for table `parcel_transfer_details`
--

CREATE TABLE `parcel_transfer_details` (
  `id` bigint UNSIGNED NOT NULL,
  `parcel_transfer_id` int NOT NULL,
  `shipment_box_id` int DEFAULT NULL,
...
--
-- Dumping data for table `parcel_transfer_details`
--

INSERT INTO `parcel_transfer_details` (`id`, `parcel_transfer_id`, `shipment_box_id`, `invoice_id`, `note`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL, '2025-09-27 03:52:47', '2025-09-27 03:52:47'),
(2, 1, 2, NULL, NULL, '2025-09-27 03:52:47', '2025-09-27 03:52:47'),
(3, 1, 3, NULL, NULL, '2025-09-27 03:52:47', '2025-09-27 03:52:47');
...
(763, 3, 1, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(764, 3, 212, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(765, 3, 213, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(766, 3, 214, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(767, 3, 215, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(768, 3, 216, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(769, 3, 217, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(770, 3, 218, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(771, 3, 219, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(772, 3, 224, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(773, 3, 225, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(774, 3, 226, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(775, 3, 29, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(776, 3, 17, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(777, 3, 90, '2025-09-18 12:16:53', '2025-09-18 12:16:53'),
(778, 3, 91, '2025-09-18 12:16:53', '2025-09-18 12:16:53');
...
CREATE TABLE `shipment_boxes` (
  `id` bigint UNSIGNED NOT NULL,
  `box_id` int NOT NULL,
  `shipment_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `from_branch_id` bigint DEFAULT NULL,
  `to_branch_id` bigint DEFAULT NULL,
  `current_branch_id` bigint DEFAULT NULL,
  `is_packed` tinyint NOT NULL DEFAULT '0' COMMENT '0=no, 1=yes',
  `status` enum('pending','approved','in_transit','delivered','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, '0000001', 3, 1, 1, 1, 'delivered', '2025-09-27 03:37:46', '2025-09-27 03:53:49'),
(2, 2, '0000002', 3, 1, 1, 1, 'delivered', '2025-09-27 03:39:15', '2025-09-27 03:53:49'),
(3, 5, '0000003', 3, 1, 1, 1, 'delivered', '2025-09-27 03:41:47', '2025-09-27 03:53:49');
...
(1, 1, 1, '2025-09-27 03:37:46', '2025-09-27 03:37:46'),
(2, 1, 2, '2025-09-27 03:37:46', '2025-09-27 03:37:46'),
(3, 1, 3, '2025-09-27 03:37:46', '2025-09-27 03:37:46'),
(4, 2, 4, '2025-09-27 03:39:15', '2025-09-27 03:39:15'),
(5, 2, 5, '2025-09-27 03:39:15', '2025-09-27 03:39:15'),
(6, 2, 6, '2025-09-27 03:39:15', '2025-09-27 03:39:15'),
(7, 3, 7, '2025-09-27 03:41:47', '2025-09-27 03:41:47'),
(8, 3, 8, '2025-09-27 03:41:47', '2025-09-27 03:41:47');
...
ALTER TABLE `parcel_transfers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `parcel_transfers_parcel_transfer_no_unique` (`parcel_transfer_no`);

--
-- Indexes for table `parcel_transfer_details`
--
