...
--
-- Host: localhost:3306
-- Generation Time: Sep 15, 2025 at 07:53 PM
...
(1, 1, 1, 1, 1, 'Super Admin', NULL, 1, '01763634878', 'admin@gmail.com', '$2y$10$HgJ9WCVRevM1e8yXz1ts7OCGRb29MdtDpBQLDhb.QObJmLPnP4ZOm', 'admin-1757960156.jpeg', 1, '2024-08-30 13:03:44', '2025-09-15 18:15:56', 'wAZpdS0wDgr2Xfy0qmuXVPw4YSW5wwLCIYlCjkfY7oL1DCMipcAC7BxHLOZq'),
...
(1, 'E-Courier', 'In consequuntur quib', 'Iusto Nam consectetu', 'logo-1757960143.png', 'favicon-1757960143.png', '+88 01680764091', '456', '23456', 'wondertech9100@gmail.com', 'Velit quia corrupti', 'Dhaka, Bangladesh.', 'Quia atque nostrum q', 'Enim neque culpa ex', 'Deserunt odio cum ad', 'Deserunt in ducimus', 'Obcaecati autem reru', 60, 23, 72, 1993, 'Sit placeat et ut o', 'Vel dolore necessita', 'Consequuntur ex nesc', 'Proident dolore off', '৳', NULL, '2025-09-15 18:15:43');
...
CREATE TABLE `boxes` (
  `id` bigint UNSIGNED NOT NULL,
  `box_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `box_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `box_type` enum('small','medium','large') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `flights` (
  `id` bigint UNSIGNED NOT NULL,
  `hub_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `flight_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `flight_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shipment_boxes` (
  ...
  `is_loaded` tinyint NOT NULL DEFAULT '0' COMMENT '0=no, 1=yes',
...
INSERT INTO `shipment_boxes` (`id`, `box_id`, `shipment_no`, `from_branch_id`, `to_branch_id`, `is_loaded`, `status`, `created_at`, `updated_at`) VALUES
(4, 1, '0000001', NULL, NULL, 1, 'approved', '2025-08-17 11:43:11', '2025-09-15 18:45:41'),
(5, 5, '0000002', NULL, NULL, 0, 'approved', '2025-08-17 12:08:09', '2025-08-17 12:25:46');
...
(51, 4, 1, '2025-09-15 18:45:28', '2025-09-15 18:45:28'),
(52, 4, 2, '2025-09-15 18:45:28', '2025-09-15 18:45:28');
