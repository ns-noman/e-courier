    ...
    public function invoice($id, $print=null)
    {
        ...
        $data['print'] = $print;
         ...
         $select = [
            ...
            'parcel_invoices.billing_weight_kg',
            ...
            'parcel_invoices.weight',

            'parcel_invoices.sender_name',
            'parcel_invoices.sender_company',
            'parcel_invoices.sender_address',
            'parcel_invoices.sender_city',
            'parcel_invoices.sender_zip',
            'parcel_invoices.sender_country_id',
            'parcel_invoices.sender_phone',
            'parcel_invoices.sender_email',
            
            'parcel_invoices.receiver_name',
            'parcel_invoices.receiver_company',
            'parcel_invoices.receiver_address',
            'parcel_invoices.receiver_city',
            'parcel_invoices.receiver_zip',
            ...
            'sender_countries.country_name as receiver_country_name',
